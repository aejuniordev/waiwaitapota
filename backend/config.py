...
secret_key = ''.join(choice(random) for i in range(48)) # without workers
config = dict(
    ...
    SECRET_KEY=os.environ.get('SECRET_KEY', "7a47336b3511466584747dbd6ef1323a894a76c4bb5a400893776723a76392127b58be72586741258d41886a4b5be5cc"),
